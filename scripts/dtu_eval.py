...
if not args.skip_training:
    ...
    for scene in dtu_scenes:
        ...
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        print("/home/zhaoyibin/anaconda3/envs/surfel_splatting/bin/python train.py -s " + source + " -m " + args.output_path + "/" + scene + common_args)
        os.system("/home/zhaoyibin/anaconda3/envs/surfel_splatting/bin/python train.py -s " + source + " -m " + args.output_path + "/" + scene + common_args)
...
if not args.skip_rendering:
    ...
    for scene in dtu_scenes:
        source = args.dtu + "/" + scene
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        print("/home/zhaoyibin/anaconda3/envs/surfel_splatting/bin/python render.py --iteration 30000 -s " + source + " -m" + args.output_path + "/" + scene + common_args)
        os.system("/home/zhaoyibin/anaconda3/envs/surfel_splatting/bin/python render.py --iteration 30000 -s " + source + " -m" + args.output_path + "/" + scene + common_args)
...
if not args.skip_metrics:
    ...
    for scene in dtu_scenes:
        ...
        iteration = 30000
        string = f"/home/zhaoyibin/anaconda3/envs/surfel_splatting/bin/python {script_dir}/eval_dtu/evaluate_single_scene.py " + \
